  ...
  theme: {
    extend: {
      colors: {
        ...
        // Mastery level colors (from design tokens)
        mastery: {
      ...
      boxShadow: {
        ...
        // Interactive shadows
        interactive: "0 2px 8px -2px rgba(0,0,0,0.1)",
        "interactive-hover": "0 4px 12px -2px rgba(0,0,0,0.15)",
        "interactive-active": "0 2px 4px -2px rgba(0,0,0,0.1)",
      },
      animation: {
